...
(function($) {
    ...
    function getImageThumbnailHtml(src) {
        //alt="input img" id="inputImg"
        return '<img src="' + src + '" alt="Image preview" id="inputImg" class="thumbnail" style="max-width: ' + options.maxWidth + 'px; max-height: ' + options.maxHeight + 'px">';
    }
